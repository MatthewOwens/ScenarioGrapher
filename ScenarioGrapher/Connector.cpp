...
void Connector::addFlag(std::string flag)
{
	flags.insert(std::pair<std::string,int>(flag, 0));
}

void Connector::addFlag(std::string flag, int val)
{
	flags.insert(std::pair<std::string, int>(flag, val));
}
